...
rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://telegram.me/sachinmirror'>@Telegram</a><br><br>By<br><br>SachinMirror</h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            <a href="https://telegram.me/sachinmirror"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->

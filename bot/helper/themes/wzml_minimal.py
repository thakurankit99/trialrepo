...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Updates'
    ST_BN1_URL = 'https://t.me/SachinMirror'
    ST_BN2_NAME = 'Owner'
    ST_BN2_URL = 'https://t.me/Sachin_769'
    ST_MSG = '''<i>This bot can mirror all your links|files|torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.
    Type {help_command} to get a list of available commands</i>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using this bot in @SachinMirror Group</i>\n\n<b>For Paid Bot With No Limits Contact @Sachin_769</b>'''
    ST_UNAUTH = '''<i>Use this bot in @SachinMirror Group!\n\n For Paid Bot Contact @Sachin_769</i>'''
...
------------------------------------------\n\n"""
    ...
    L_CC =                  '┖ <b>By: </b>{Tag} | <b>ID:</b> <code>{uid}</code>\n\n'
    ...
    M_CC =                  '┖ <b>By: </b>{Tag} | <b>ID:</b> <code>{uid}</code>\n\n'
    ...
    INDEX_LINK_D =    '⚡ Open Index Link'
    CHECK_PM =        'View in Bot PM'
    #JOIN_LEECH =      'Join Leech Dump'

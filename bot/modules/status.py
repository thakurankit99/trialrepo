...
async def mirror_status(_, message):
    ...
    if count == 0:
        ...
        #modified_total_space_str = get_readable_file_size(modified_total_space_bytes)
        ...
        msg = BotTheme('NO_ACTIVE_DL', cpu=cpu_percent(), free=modified_free_space_str, free_p=round(free_percentage, 1),
                       ram=mem_percent, uptime=currentTime)
